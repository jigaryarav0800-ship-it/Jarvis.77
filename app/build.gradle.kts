...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.jarvisai.kxmpzq"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    create("release") {
      ...
      val customFile = file(customKeystorePath)
      if (customFile.exists()) {
        ...
        // Fallback to debug keystore for automated builds when release key is not supplied
